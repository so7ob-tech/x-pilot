...
export type IconName = 'play' | 'pause' | 'stop' | 'queue' | 'bank' | 'workspace' | 'settings' | 'analytics' | 'activity' | 'diagnostics' | 'search' | 'refresh' | 'more' | 'delete' | 'archive' | 'restore' | 'check' | 'warning' | 'error' | 'calendar' | 'clock' | 'chevron';
