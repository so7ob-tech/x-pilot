...
- أصبحت نصوص التبويبات بجوار الرموز في صف أفقي بدل ظهورها فوقها أو تحتها.
- تم توحيد المسافات والهوامش الأساسية بين جميع التبويبات، وليس تبويب التشغيل فقط.
- صُغّرت مساحة شريط التبويبات وبطاقات المحتوى لتقليل اختلاف الارتفاع عند الانتقال بين الصفحات.
- بقيت أسماء التبويبات مرئية وقابلة للاستخدام عبر الفأرة ولوحة المفاتيح.
