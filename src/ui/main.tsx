...
function App() {
  ...
  return <main className={`shell shell-${activeTab}`}>
    ...
    <nav className="tabs-bar" aria-label="حالة X-Pilot والتبويبات"><div className="tabs" role="tablist">
      <div className="nav-group"><span>CONTROL</span><TabButton id="operation" activeTab={activeTab} onSelect={setActiveTab} icon="play" label="التشغيل" /><TabButton id="tests" activeTab={activeTab} onSelect={setActiveTab} icon="check" label="اختبارات البدء" /></div>
      <div className="nav-group"><span>CONTENT</span><TabButton id="queue" activeTab={activeTab} onSelect={setActiveTab} icon="bank" label="بنك التغريدات" /></div>
      <div className="nav-group"><span>ACTIVITY</span><TabButton id="sessions" activeTab={activeTab} onSelect={setActiveTab} icon="clock" label="الجلسات" /><TabButton id="history" activeTab={activeTab} onSelect={setActiveTab} icon="activity" label="السجل" /></div>
      <div className="nav-group"><span>INSIGHTS</span><TabButton id="analytics" activeTab={activeTab} onSelect={setActiveTab} icon="analytics" label="التحليلات" /><TabButton id="diagnostics" activeTab={activeTab} onSelect={setActiveTab} icon="diagnostics" label="التشخيص" /></div>
      <div className="nav-group"><span>MANAGE</span><TabButton id="workspaces" activeTab={activeTab} onSelect={setActiveTab} icon="workspace" label="مساحات العمل" /><TabButton id="settings" activeTab={activeTab} onSelect={setActiveTab} icon="settings" label="الإعدادات" /></div>
